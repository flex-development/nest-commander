...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/nest-commander
   cd nest-commander
   ```
...
```sh
https://github.com/flex-development/nest-commander/compare/main...$branch
```
...
[19]: https://github.com/flex-development/nest-commander/discussions/new?category=q-a
